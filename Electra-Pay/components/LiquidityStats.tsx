...
export function LiquidityStats() {
  ...
  const stats = [
    { 
      ...
      value: `${formatEther(totalActiveDeposits)} ETH`,
    ...
    { 
      ...
      value: `${formatEther(totalPendingRewards).slice(0, 15)} ETH`,
    ...
    { 
      ...
      value: `${(Number(formatEther(totalActiveDeposits)) * 0.08 / 12).toFixed(4)} ETH`,

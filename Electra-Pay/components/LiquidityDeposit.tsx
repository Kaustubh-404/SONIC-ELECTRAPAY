        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs text-zinc-500">Available: {maxAmount.toFixed(4)} ETH</span>
            </div>
            <div className="relative">
              ...
              />
              <span className="absolute right-1 top-1/2 transform -translate-y-1/2 text-zinc-400">ETH</span>
              <button
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-white">
                    {depositAmount ? 
                      `${(parseFloat(depositAmount) * (Number(selectedPoolData.apy) / 10000) / 365).toFixed(6)} ETH` : 
                      "0.00 ETH"}
                  </div>
                </div>
                <div className="space-y-1">
                  ...
                  <div className="text-white">
                    {depositAmount ? 
                      `${(parseFloat(depositAmount) * (Number(selectedPoolData.apy) / 10000) / 12).toFixed(4)} ETH` : 
                      "0.00 ETH"}
                  </div>
                </div>
              </div>
